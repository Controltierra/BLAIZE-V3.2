...
Blaize V3 con panel de control web, drawboard interactivo, control de velocidad y **tracking automático con MediaPipe**.
...
### 7. 🆕 MediaPipe Spot Follower ⭐
- **Tracking automático de movimientos corporales** usando MediaPipe
- **Preset 32**: Los spots siguen tu cuerpo en tiempo real
- Detección de nariz, muñecas y hombros
- Efectos visuales con glow y líneas de conexión
- **Scripts incluidos**:
  - `mediapipe_tracker.py` - Tracking con webcam
  - `test_mediapipe_connection.py` - Test sin cámara
  - `start_mediapipe.bat` - Inicio rápido en Windows
- Ver [MEDIAPIPE_QUICKSTART.md](MEDIAPIPE_QUICKSTART.md) para uso rápido
- Ver [MEDIAPIPE_SETUP.md](MEDIAPIPE_SETUP.md) para documentación completa
...
Blaize_V3_Modificado/
 ...
 mediapipe_tracker.py        # 🆕 Tracker de MediaPipe
 test_mediapipe_connection.py # 🆕 Test de conexión
 start_mediapipe.bat         # 🆕 Script inicio rápido
 MEDIAPIPE_QUICKSTART.md     # 🆕 Guía rápida MediaPipe
 MEDIAPIPE_SETUP.md          # 🆕 Documentación completa
 data/
